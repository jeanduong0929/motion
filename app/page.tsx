...
const Home = () => {
  const cards = [
    {
      id: "1",
      svg: (
        <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current mb-2">
      ...
      description:
        "Mark tasks as done with a single click. Feel the satisfaction without the distraction.",
    },
    {
      id: "2",
      svg: (
      ...
      title: "Sleek Drag-and-Drop",
      description:
        "Organize your tasks effortlessly. A simple drag, a simple drop. Keep your focus where it belongs.",
    },
    {
      id: "3",
      svg: (
      ...
      description:
        "Add tasks in a blink with our streamlined input. Just type and hit enter. It’s that simple.",
    },
  ];
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col items-center justify-between min-h-[70vh] gap-10 my-24 mx-auto max-w-screen-xl w-11/12 container-fade-in">
